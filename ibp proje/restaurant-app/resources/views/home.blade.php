      ...
      <nav>
          ...
          <div class="navigation-bar">
              <ul style="padding-left: 400px;">
                  <li><a href="{{route('login')}}">Giriş<span  class="underline"></span></a></li>
                  <li><a href="{{route('registration')}}">Kaydol<span class="underline"></span></a></li>
              </ul>
          </div>
      </nav>
      <div class="text">
      ...
      <div class="contact-container">
        <div class="social-media">
          ...
          <div class="newsletter">
            <h3>Bize Ulaşın!</h3>
            <p>Bunun için <a href="{{route('login')}}"> oturum açmalısınız </a> </p>
          </div>
      </div>
  </footer>
<!--End Footer-->
